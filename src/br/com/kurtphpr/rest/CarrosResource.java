...
public class CarrosResource {
	...
	public Response delete(@PathParam("id") long id) {
		...
		return Response.Ok("Carro com id=" + id + " foi deletado com sucesso!");
	}
	
	@POST
	public Response post(Carro c){
		carroService.save(c);
		return Response.Ok("Carro " + c.getDesc() + " foi salvo com sucesso!");
	...
	public Response put(Carro c){
		carroService.save(c);
		return Response.Ok("Carro " + c.getDesc() + " foi atualizado com sucesso!");
	}
